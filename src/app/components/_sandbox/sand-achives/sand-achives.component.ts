...
@Component({
  selector: 'app-sand-achives',
  templateUrl: './sand-achives.component.html',
  styleUrls: ['./sand-achives.component.scss'],
  animations: [
    fadeInRightOnEnterAnimation(DURATION),
    fadeOutRightOnLeaveAnimation(DURATION)
  ]
})
export class SandAchivesComponent implements OnInit {
  // *************************** TEMPLATE CONDITIONS ***************************
