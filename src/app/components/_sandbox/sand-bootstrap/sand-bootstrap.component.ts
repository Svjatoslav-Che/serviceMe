...
@Component({
  selector: 'app-sand-bootstrap',
  templateUrl: './sand-bootstrap.component.html',
  styleUrls: ['./sand-bootstrap.component.scss'],
  animations: [
    fadeInRightOnEnterAnimation(DURATION),
    fadeOutRightOnLeaveAnimation(DURATION)
  ]
})
export class SandBootstrapComponent implements OnInit {
  // *************************** TEMPLATE CONDITIONS ***************************
