...
@Component({
  selector: 'app-sand-structure',
  templateUrl: './sand-structure.component.html',
  styleUrls: ['./sand-structure.component.scss'],
  animations: [
    fadeInRightOnEnterAnimation(DURATION),
    fadeOutRightOnLeaveAnimation(DURATION)
  ]
})
export class SandStructureComponent implements OnInit {
  // *************************** TEMPLATE CONDITIONS ***************************
